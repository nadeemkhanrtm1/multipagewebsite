                ...
                <div className={Styles.fourPart}>
                    ...
                    <div className={Styles.seconddiv}>
                            ...
                            <div className={Styles.ante_col}>
                                ...
                                <a href="/leftsidebar">Erat blandit risus vis adipiscing</a><br/><br/>
                                <a href="/leftsidebar">Tempus ultricies faucibus amet</a><br/><br/>
                                <a href="/leftsidebar">Arcu commodo non adipiscing quis</a><br/><br/>
                                <a href="/leftsidebar">Accumsan vis lacinia semper</a><br/><br/>
                                <a href="/leftsidebar">Erat blandit risus vis adipiscing</a><br/><br/>
                                <a href="/leftsidebar">Tempus ultricies faucibus amet</a><br/><br/>
                                <a href="/leftsidebar">Arcu commodo non adipiscing quis</a><br/><br/>
                                <a href="/leftsidebar">Accumsan vis lacinia semper</a><br/><br/>
                        ...
                        <div className={Styles.mollis_col}>
                            ...
                            <img src={process.env.PUBLIC_URL + "./pic03.jpg"} alt="Left Side Bar"></img>
                    ...
                    <div className={Styles.lastdiv}>
                        <div className={Styles.lastdivinner}>
                            <div className={Styles.accumsan}>
                                <h3>ACCUMSAN</h3>
                                <a href="/leftsidebar">Nascetur nunc varius</a><br/><br/>
                                <a href="/leftsidebar">Vis faucibus sed tempor</a><br/><br/>
                                <a href="/leftsidebar">Massa amet lobortis vel</a><br/><br/>
                                <a href="/leftsidebar">Nascetur nunc varius</a><br/><br/>
                            </div>
                            ...
                            <div className={Styles.ali}>
                                ...
                                <a href="/leftsidebar"><FaTwitter className="twitter"/></a>
                                <a href="/leftsidebar"><FaFacebook className="twitter"/></a>
                                <a href="https://www.instagram.com/__name__.syntax_error/"><FaInstagram className="twitter"/></a>
                                <a href="/leftsidebar"><FaLinkedinIn className="twitter"/></a>  
                            </div>
                        </div>
